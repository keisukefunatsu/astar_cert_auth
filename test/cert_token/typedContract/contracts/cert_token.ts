...
import ABI from '../../artifacts/cert_token.json';
import QueryMethods from '../query/cert_token';
import BuildExtrinsicMethods from '../build-extrinsic/cert_token';
import TxSignAndSendMethods from '../tx-sign-and-send/cert_token';
import MixedMethods from '../mixed-methods/cert_token';
import EventsClass from '../events/cert_token';
