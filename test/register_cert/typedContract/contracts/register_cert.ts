...
import ABI from '../../artifacts/register_cert.json';
import QueryMethods from '../query/register_cert';
import BuildExtrinsicMethods from '../build-extrinsic/register_cert';
import TxSignAndSendMethods from '../tx-sign-and-send/register_cert';
import MixedMethods from '../mixed-methods/register_cert';
import EventsClass from '../events/register_cert';
